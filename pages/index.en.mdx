  ...
  <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
    <div class="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
      ...
      <div class="flex justify-center">
        ...
        <a href="#" class="mr-5 inline-block rounded-xl bg-black px-8 py-4 text-center font-semibold text-white [box-shadow:rgb(19,_83,_254)_6px_6px] md:mr-6">Get Test</a>
      </div>
    </div>
